 ...
 * @author the_scs
 */
public class ReturnFlightUI extends javax.swing.JFrame {
    ...
    private ReturnFlight selectedFlight;
    ...
    public ReturnFlightUI() {
        initComponents();

        // Display flight information when the instance is created
        displayNextReturnFlights(5);
    }

    public ReturnFlightUI(String departureAirport, String arrivalAirport, String departureDate, String returnDate, int numPassengers, String travelClass, boolean oneWay, float departureFlightPrice, String departureTime, String arrivalTime, int depFlightID) {
        ...
        returnFlights = programManager.retrieveReturnFlights(this.arrivalAirport, this.departureAirport, this.retDate);
    ...
    private void btnPrice1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrice1ActionPerformed
        ...
        selectedFlight = returnFlights.get(0);
        ProgramManager programManager = new ProgramManager();
        ...
        FlightBookingUI mainFrame = new FlightBookingUI(departureAirport, arrivalAirport, departureDate, returnDate, numPassengers, travelClass, oneWay, departureFlightPrice, numPassengers * (selectedFlight.getScheduledFlightPrice() + programManager.retrieveClassPrice(programManager.retrieveClassID(travelClass))), departureTime, arrivalTime, selectedFlight.getScheduledFlightDepartureTime(), selectedFlight.getScheduledFlightArrivalTime(), depFlightID, selectedFlight.getScheduledFlightID());
    ...
    private void btnPrice2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrice2ActionPerformed
        // User does not want a return flight, proceed to the payment frame
        selectedFlight = returnFlights.get(currentIndex);
        ProgramManager programManager = new ProgramManager();
        ...
        // Close the current frame (assuming this is in DepartureFlightsFrame)
        this.dispose();
    ...
    private void btnNextFlightsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFlightsActionPerformed
        ...
        displayNextReturnFlights(numFlightsToDisplay);
    ...
    private void displayNextReturnFlights(int numFlightsToDisplay) {
        ProgramManager programManager = new ProgramManager();
        int classCapacity = -1;
        ...
        totalPages = (int) Math.ceil((double) returnFlights.size() / numFlightsToDisplay);
        ...
        for (int i = 0; i < numFlightsToDisplay; i++) {
            if (currentIndex < returnFlights.size()) {
                JPanel flightPanel = getFlightInfoPanel(i + 1);
                ReturnFlight flight = returnFlights.get(currentIndex);
                ...
                returnFlightPrice = totalFlightPrice;
        ...
        if (!flightsAvailable) {
            ...
            lblAvailableFlightsTxt.setText("No Flights Available for the Specified Return Date");
        } else if (currentIndex >= returnFlights.size()) {
            ...
            lblAvailableFlightsTxt.setText("Available Return Flights for " + outputDateStr);
            btnNextFlights.setVisible(false);
        }
    }
...
// Repeat the above block for btnPrice2, btnPrice3, btnPrice4, btnPrice5
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReturnFlightUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReturnFlightUI().setVisible(true);
            }
        });
    }
