...
public class ScheduledFlight {
    ...
    public ScheduledFlight(int numFlights) {
        this.numFlights = numFlights;
    }

    public ScheduledFlight(int scheduledFlightID, float scheduledFlightPrice, String scheduledFlightDepartureDate, String scheduledFlightDepartureTime, String scheduledFlightArrivalDate, String scheduledFlightArrivalTime, String scheduledFlightStatus, int departureAirportID,
