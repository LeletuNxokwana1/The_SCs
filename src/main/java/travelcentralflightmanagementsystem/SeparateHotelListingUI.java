...
public class SeparateHotelListingUI extends javax.swing.JFrame {
    ...
    public SeparateHotelListingUI(String checkInDate, String checkOutDate, boolean meals, int arrivalAirportID, String bookingNumber) {
        initComponents();
        ...
        lblTitle.setText(programManager.retrieveCityName(arrivalAirportID) + " Hotel rooms for a " + calculateNumberOfDays(checkInDate, checkOutDate) +" night(s) stay");
        populateTable();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1536, 800));
        ...
        jScrollPane1.setBounds(20, 170, 1500, 380);
    ...
    private void btnReserveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReserveActionPerformed
        if (meals) {
            SeparateHotelMealsUI hotelMeals = new SeparateHotelMealsUI(checkInDate, checkOutDate, meals, (int) Float.parseFloat(lblCost.getText()), calculateNumberOfDays(checkInDate, checkOutDate), bookingNumber, arrivalAirportID);
            hotelMeals.setVisible(true);
            this.dispose();
        } else {
            SeparateHotelBookingUI hotelBooking = new SeparateHotelBookingUI(checkInDate, checkOutDate, meals, Float.parseFloat(lblCost.getText()), calculateNumberOfDays(checkInDate, checkOutDate), 0, bookingNumber, arrivalAirportID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeparateHotelListingUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new SeparateHotelListingUI().setVisible(true);
            }
        });
    }
