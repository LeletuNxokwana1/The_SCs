...
public class HotelBookingUI extends javax.swing.JFrame {
    ...
    public HotelBookingUI(String departureAirport, String arrivalAirport, String departureDate, String returnDate, int numPassengers, String travelClass, boolean oneWay, float departureFlightPrice, float returnFlightPrice, String departureTime, String arrivalTime, String rDepartureTime, String rArrivalTime, int depFlightID, int retFlightID, String checkInDate, String checkOutDate, boolean meals, float hotelCost, int numNights, float mealCost) {
    ...
    private void initComponents() {
        ...
        pnlFlightDeatails = new javax.swing.JPanel();
        ...
        setPreferredSize(new java.awt.Dimension(1536, 1507));
        ...
        lblFlightDetails.setBounds(210, 30, 212, 48);
        ...
        pnlFlightDeatails.setBackground(new java.awt.Color(255, 255, 255));
        pnlFlightDeatails.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, java.awt.Color.black));
        pnlFlightDeatails.setLayout(null);
        ...
        pnlFlightDeatails.add(lblDepartureFlight);
        lblDepartureFlight.setBounds(10, 0, 544, 40);

        lblDeparture.setText("Departure");
        pnlFlightDeatails.add(lblDeparture);
        lblDeparture.setBounds(10, 50, 65, 16);

        lblArrival.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblArrival.setText("Arrival");
        pnlFlightDeatails.add(lblArrival);
        lblArrival.setBounds(490, 50, 60, 16);

        lblDepartureAirport.setText("Departure Airport (IATA Code)");
        pnlFlightDeatails.add(lblDepartureAirport);
        lblDepartureAirport.setBounds(10, 70, 272, 16);

        lblDepartureTime.setText("--:--");
        pnlFlightDeatails.add(lblDepartureTime);
        lblDepartureTime.setBounds(10, 100, 63, 16);
        ...
        pnlFlightDeatails.add(lblArrivalAirport);
        lblArrivalAirport.setBounds(280, 70, 266, 16);

        lblArrivalTime.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblArrivalTime.setText("--:--");
        pnlFlightDeatails.add(lblArrivalTime);
        lblArrivalTime.setBounds(500, 100, 54, 16);

        lblDepartureFlightTotal.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblDepartureFlightTotal.setText("0000.00");
        pnlFlightDeatails.add(lblDepartureFlightTotal);
        lblDepartureFlightTotal.setBounds(500, 120, 60, 16);

        lblDepartureFlightR.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblDepartureFlightR.setText("R");
        pnlFlightDeatails.add(lblDepartureFlightR);
        lblDepartureFlightR.setBounds(450, 120, 37, 16);

        lblNumPassengers.setText("0 Passenger(s)");
        pnlFlightDeatails.add(lblNumPassengers);
        lblNumPassengers.setBounds(20, 240, 110, 16);

        lblClass.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblClass.setText("Travel Class");
        pnlFlightDeatails.add(lblClass);
        lblClass.setBounds(240, 240, 90, 20);

        lblReturnFlightR1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblReturnFlightR1.setText("R");
        pnlFlightDeatails.add(lblReturnFlightR1);
        lblReturnFlightR1.setBounds(450, 240, 37, 16);

        lblReturnFlightTotal1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblReturnFlightTotal1.setText("0000.00");
        pnlFlightDeatails.add(lblReturnFlightTotal1);
        lblReturnFlightTotal1.setBounds(500, 240, 60, 16);

        lblRDeparture.setText("Departure");
        pnlFlightDeatails.add(lblRDeparture);
        lblRDeparture.setBounds(10, 170, 65, 16);

        lblRDepartureAirport.setText("Departure Airport (IATA Code)");
        pnlFlightDeatails.add(lblRDepartureAirport);
        lblRDepartureAirport.setBounds(10, 190, 272, 16);

        lblRDepartureTime.setText("--:--");
        pnlFlightDeatails.add(lblRDepartureTime);
        lblRDepartureTime.setBounds(10, 210, 63, 16);

        lblRArrival.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblRArrival.setText("Arrival");
        pnlFlightDeatails.add(lblRArrival);
        lblRArrival.setBounds(490, 170, 60, 16);
        ...
        pnlFlightDeatails.add(lblRArrivalAirport);
        lblRArrivalAirport.setBounds(290, 190, 266, 16);

        lblRArrivalTime.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblRArrivalTime.setText("--:--");
        pnlFlightDeatails.add(lblRArrivalTime);
        lblRArrivalTime.setBounds(500, 210, 54, 16);
        ...
        pnlFlightDeatails.add(lblReturnFlight);
        lblReturnFlight.setBounds(10, 130, 544, 30);

        pnlDetails.add(pnlFlightDeatails);
        pnlFlightDeatails.setBounds(210, 80, 560, 270);
        ...
        pnlHotelDetails.setBounds(780, 80, 560, 270);
        ...
        btnProceedToPayment.setBounds(640, 410, 200, 50);
        ...
        lblHotelDetails.setBounds(780, 30, 212, 48);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(pnlHead, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 1638, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(63, 63, 63))
        );
    ...
    private void btnPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayActionPerformed
        ...
        int hotelID = programManager.retrieveHotelIDByCityID(programManager.retrieveCityID(arrivalAirport));
        
        // Call the method to add flight and hotel booking
        if (oneWay){
            programManager.addHotelBooking(bookingReference, checkInDate, checkOutDate, hotelCost, "Confirmed", userID, hotelID);
            programManager.addOneWayFlightBooking(bookingReference, numPassengers, departureFlightPrice, "Confirmed", userID, programManager.retrieveClassID(travelClass), depFlightID, departureFlightPrice + hotelCost + mealCost); 
        } else {
            programManager.addHotelBooking(bookingReference, checkInDate, checkOutDate, hotelCost, "Confirmed", userID, hotelID);
            programManager.addReturnFlightBooking(bookingReference, numPassengers, departureFlightPrice + returnFlightPrice, "Confirmed", userID, programManager.retrieveClassID(travelClass), depFlightID, retFlightID, departureFlightPrice + returnFlightPrice + hotelCost + mealCost); 
        }
        
          
        HotelBookingConfirmationUI mainFrame = new HotelBookingConfirmationUI(bookingReference);
    ...
    private void populateDetails() {
        ...
        lblTotal.setText(Float.toString(departureFlightPrice + returnFlightPrice + hotelCost + mealCost));
    ...
    private javax.swing.JPanel pnlFlightDeatails;
