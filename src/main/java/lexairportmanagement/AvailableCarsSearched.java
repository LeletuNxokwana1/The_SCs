 ...
 * @author lelet
 */
public class AvailableCarsSearched extends javax.swing.JFrame {

    /**
     * Creates new form AvailableCarsSearched
     */
    public AvailableCarsSearched() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select your Car and hit to the road");
        ...
        jLabel1.setText("Your Fantasy Car");

        jButton1.setBackground(new java.awt.Color(0, 0, 0));
        jButton1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Back to Search Car");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvailableCarsSearched.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AvailableCarsSearched().setVisible(true);
            }
        });
    }
