...
public class DepartureFlight {
    ...
    public DepartureFlight(int numFlights) {
        this.numFlights = numFlights;
    }
    

    public DepartureFlight(int scheduledFlightID, float scheduledFlightPrice, String scheduledFlightDepartureDate, String scheduledFlightDepartureTime, String scheduledFlightArrivalDate, String scheduledFlightArrivalTime, String scheduledFlightStatus, int departureAirportID,
