...
public class SeparateHotelSearchUI extends javax.swing.JFrame {
    ...
    public SeparateHotelSearchUI(String departureDate, int arrAirportID, String bookingNumber) {
    ...
    private void btnReserveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReserveActionPerformed
        ...
        SeparateHotelListingUI hotelListing = new SeparateHotelListingUI(checkInDate, checkOutDate, meals, arrivalAirportID, bookingNumber);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeparateHotelSearchUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new SeparateHotelSearchUI().setVisible(true);
            }
        });
    }
